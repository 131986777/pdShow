<template>
    <div class="magnifier-box" :class="vertical?'vertical':''" :ref="id" @mousemove="mousemove" @mouseover="mouseover"
    ...
    export default {
        ...
        methods: {
            ...
            initTime() {
                ...
                if (this.IEVersion() <= -1) {
                    document.body.append(this.canvas) //不是ie
                }
                else {
                    document.body.insertBefore(this.canvas) //ie
                }
